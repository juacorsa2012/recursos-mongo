...
module.exports = {
    SUCCESS: SUCCESS,
    ERROR  : ERROR,
    SERVIDOR_CORRIENDO   : SERVIDOR_CORRIENDO,
    INTERNAL_SERVER_ERROR: INTERNAL_SERVER_ERROR,
    CONEXION_DB_CORRECTA : CONEXION_DB_CORRECTA,
    CONEXION_DB_ERROR    : CONEXION_DB_ERROR,
    NOMBRE_REQUERIDO     : NOMBRE_REQUERIDO,
    OBJECT_ID_NO_VALIDO  : OBJECT_ID_NO_VALIDO,
    UNIDADES_REQUERIDAS  : UNIDADES_REQUERIDAS,    
    UNIDADES_MINIMAS     : UNIDADES_MINIMAS,
    TEMA_NO_ENCONTRADO   : TEMA_NO_ENCONTRADO,
    TEMA_REGISTRADO      : TEMA_REGISTRADO,    
    TEMA_ACTUALIZADO     : TEMA_ACTUALIZADO,
    IDIOMA_REGISTRADO    : IDIOMA_REGISTRADO,
    IDIOMA_ACTUALIZADO   : IDIOMA_ACTUALIZADO,
    IDIOMA_NO_ENCONTRADO    : IDIOMA_NO_ENCONTRADO,
    EDITORIAL_NO_ENCONTRADA : EDITORIAL_NO_ENCONTRADA,
    EDITORIAL_REGISTRADA    : EDITORIAL_REGISTRADA,
